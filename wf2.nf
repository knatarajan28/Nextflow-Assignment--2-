...
// run the file with the following command code: nextflow run wf2.nf --reads1 /path/to/SRR26244988_1.fastq.gz --reads2 /path/to/SRR26244988_2.fastq.gz

nextflow.enable.dsl=2

// Defining default values for the input parameters
params.reads1 = null
params.reads2 = null 

// Checking if input parameters are provided 
